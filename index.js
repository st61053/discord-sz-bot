...
const token = "MTA5NTkyODA0NjE3Njk4MDk5Mg.G9uw2i.5h7cgG5Aj-nlknOQ4v1xjSOc6y46Bc-uLgCVW0";
...
client.on('messageCreate', async message => {
  ...
  const channel = message.client.channels.cache.get('1094501107503464488');
    ...
    await channel.send(`${user} has sent ${userDoc.data().messageCount} messages`);
